...
extern refresh_line_number_gutter_width  ; linenum.asm -- re-sizes the gutter for whatever font on_font_chosen just applied
...
on_font_chosen:
    ...
    ICALL refresh_line_number_gutter_width                        ; linenum.asm -- a new font may need a wider (or narrower) gutter to fit "99999" in it
